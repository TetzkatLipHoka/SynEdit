...
type
  ...
  private
    ...
    procedure DoAddDirectivesKeyword(AKeyword: String; AKind: Integer);
    procedure DoAddRegisterKeyword(AKeyword: String; AKind: Integer);
    procedure DoAddApiKeyword(AKeyword: String; AKind: Integer);
    procedure DoAddOperatorKeyword(AKeyword: String; AKind: Integer);
...
const
  ...
  Operators: String = '+,-,*,/,==,!=,>,>=,<,<=,||,&&,&,!,carry?,overflow?,'+
...
//  Operators: String = 'abs,addr,and,dup,eq,ge,'+
//                              'gt,high,high32,highword,imagerel,le,length,lengthof,' +
//                              'low,low32,lowword,lroffset,lt,mask,mod,ne,not,offset,' +
//                              'opattr,or,ptr,seg,shl,.type,sectionrel,short,shr,' +
//                              'size,sizeof,this,type,width,xor';
...
//
//  StringControl: String = 'catstr,instr,sizestr,substr';
//
//  Miscellaneous: String = '=,comment,display,echo,equ,%out';

procedure TSynAsmMASMSyn.DoAddKeyword(AKeyword: String; AKind: Integer);
var
  HashValue: Cardinal;
begin
...
procedure TSynAsmMASMSyn.DoAddDirectivesKeyword(AKeyword: String; AKind: Integer);
var
  HashValue: Cardinal;
begin
  HashValue := HashKey(PWideChar(AKeyword));
...
procedure TSynAsmMASMSyn.DoAddRegisterKeyword(AKeyword: String; AKind: Integer);
var
  HashValue: Cardinal;
begin
  HashValue := HashKey(PWideChar(AKeyword));
...
procedure TSynAsmMASMSyn.DoAddApiKeyword(AKeyword: String; AKind: Integer);
var
  HashValue: Cardinal;
begin
  HashValue := HashKey(PWideChar(AKeyword));
...
procedure TSynAsmMASMSyn.DoAddOperatorKeyword(AKeyword: String; AKind: Integer);
var
  HashValue: Cardinal;
begin
  HashValue := HashKey(PWideChar(AKeyword));
...
function TSynAsmMASMSyn.GetSampleSource: String;
begin
...
class function TSynAsmMASMSyn.GetFriendlyLanguageName: String;
begin
