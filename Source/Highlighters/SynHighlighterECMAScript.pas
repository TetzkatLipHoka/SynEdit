...
function TSynECMAScriptSyn.GetKeyWords(TokenKind: Integer): String;
begin
  Result :=
...
function TSynECMAScriptSyn.GetSampleSource: String;
begin
  Result :=
...
class function TSynECMAScriptSyn.GetFriendlyLanguageName: String;
begin
